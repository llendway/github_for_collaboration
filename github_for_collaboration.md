...
Click on the "New" button. Name your repository `NAME_test_repo`, where `NAME` is actually your name, and click "Initialize this repository with a README". Then click Create repository.
